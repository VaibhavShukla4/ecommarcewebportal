...
import GPay from '@/app/assets/icons/googlepay.svg';
...
const page : React.FC= () => {
      ...
      <div className="shop-details">
        ...
        <div className="copy-right">
          ...
          <div className="payment">
            <div>
              <Image alt='Payal' src={Visa.src} width={Visa.width} height={Visa.height} />
            </div>
            <div>
              <Image
                src={Mastercard.src}
  ...
  alt='Payal'
            ...
            <div>
              <Image  alt='Payal' src={Pay.src} width={Pay.width} height={Pay.height} />
            </div>
            <div>
              <Image alt='Payal' src={GPay.src} width={GPay.width} height={GPay.height} />
            </div>
          </div>
        </div>
      </div>
